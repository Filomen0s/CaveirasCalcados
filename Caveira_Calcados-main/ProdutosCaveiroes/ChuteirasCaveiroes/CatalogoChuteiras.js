...
function MostrarItens() {
    ...
    let produtos = JSON.parse(localStorage.getItem("produtosChuteiras"))
...
function PaginaChuteira_1(){
    window.location.href = "Chuteira_1/Chuteira_1.html"
}

function PaginaChuteira_2(){
    window.location.href = "Chuteira_2/Chuteira_2.html"
}

function PaginaChuteira_3(){
    window.location.href = "Chuteira_3/Chuteira_3.html"
}
