function ExibirProduto(){
    const produtos = JSON.parse(localStorage.getItem("produtosChuteiras"))
    ...
    nomeProduto.innerHTML = produtos[2].nome
    precoProduto.innerHTML = `R$ ${produtos[2].preco}`
    descProduto.innerHTML = produtos[2].descricao
    img1.src = produtos[2].urlImageExibir1
    img2.src = produtos[2].urlImageExibir2
}
...
function IrParaChuteiras(){
    window.location.href = "../CatalogoChuteiras.html"
}
